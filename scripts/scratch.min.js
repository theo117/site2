...
function createScratchCard(a) {
	...
	function K() {
		...
		"#" !== a.foreground.charAt(0) || 4 != a.foreground.length && 7 != a.foreground.length?(d.topImage.crossOrigin = "anonymous",
			d.topImage.src = a.foreground,
			d.topImage.onload = function () {
			"undefined" !== typeof a.scratchedOverlay?(h.drawImage(d.topImage, 0, 0, e, f),
				h.globalCompositeOperation = "destination-out", h.drawImage(a.scratchedOverlay, 0, 0, e, f)):h.drawImage(d.topImage, 0, 0, e, f);
			F()
		...
		"undefined" != typeof a.coin?(d.coinImage.src = a.coin,
			d.coinImage.onload = function () {
		...
		"undefined" != typeof a.counter && (d.counter = a.counter,
			r = window[a.counter]);
	...
	function H(a) {
		for (var b = 0,
			d = 0;
		a;
		)b += a.offsetLeft + a.clientLeft, d += a.offsetTop + a.clientTop,
			a = a.offsetParent;
		return {
			x: b,
			y: d
	...
	function k(a) {
		var D = !1;
		if ("touchmove" == a.type)a.preventDefault(),
			D = !1;
		...
		if (isMouseDown) {
			var e = a.pageX - this.offsetLeft,
				...
				e = a.pageX - g.x,
				f = a.pageY - g.y;
			if ("touchmove" == a.type || "touchstart" == a.type)J = 20,
				f = a.touches[0],
				e = f.pageX - g.x,
				f = f.pageY - g.y;
			h.save();
			...
			h.fill();
			h.restore();
			if ("touchmove" == a.type || "touchstart" == a.type || "touchend" == a.type)b.style.marginRight = "1px",
	...
	function z(l) {
		...
		l && !a.hasEnded?(a.hasEnded = !0, c.style.setProperty("cursor", "default", "important"), b.style.setProperty("cursor", "default", "important"),
			g.style.display = "none", delete a.scratchedOverlay,
			c.innerHTML = "", 0 != d.counter && "function" === typeof r && r(s, a),
			l = window[a.callback], "function" === typeof l && l(a)):l || a.hasEnded || (0 !=x && (c.style.width = x), 0 !=y && (c.style.height = y),
	...
	function I(l) {
		if (0 ==M++ %J || l) {
			l = 0;
			for (var b = h.getImageData(0, 0, e, f).data,
				c = 0,
				g = b.length - 20;
			c < g;
			c += 80)0 < b[c] &&l++;
	...
	"undefined" !== typeof a.width && "undefined" !== typeof a.height && (e = a.width,
		f = a.height);
	if (!window.HTMLCanvasElement || 1 == a.flash) {
		if ("undefined" !== typeof a.flashPath)return"undefined" != typeof a.background && (d.bottomImage.onload = function () {
			...
			b.data = a.flashPath;
			"undefined" !== typeof a.container && 0 != a.container.offsetWidth * a.container.offsetHeight?(b.width = a.container.offsetWidth,
				b.height = a.container.offsetHeight):(b.width = d.bottomImage.width,
				b.height = d.bottomImage.height);
	...
	if ("undefined" != typeof a.container)c = a.container,
		e = c.offsetWidth,
		f = c.offsetHeight, c.style.setProperty("position", "relative", "important"), c.style.setProperty("padding", "0", "important"), C(c);
	else return!1;
	if ("undefined" == typeof a.background || a.hasEnded)return!1;
	d.bottomImage.onload = function () {
		0 !=e && 0 == f?(y = "auto",
			f = e / d.bottomImage.width * d.bottomImage.height,
			c.style.height = f + "px"):0 ==e && 0 !=f && (x = "auto",
			e = f / d.bottomImage.height * d.bottomImage.width,
			c.style.width = e + "px");
		0 ==e *f && (y = x = "auto",
			e = d.bottomImage.width,
			f = d.bottomImage.height,
			c.style.width = e + "px",
			c.style.height = f + "px");
