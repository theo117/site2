function extendHype(a, b, c) {
	return a.checkOverlapping = function (b, c) {
		function m(a) {
			var b = new Object,
				c = a.getBoundingClientRect();
			return b.radius = c.width / 2,
				b.left = c.left + b.radius,
				b.top = c.top + b.radius, b
		}
		
		if (!b || !c)return!1;
		Object.prototype.toString.call(c).indexOf("Element") != -1 && (c = [c]), "undefined" != typeof a.ondragZindex?a.ondragZindex++:a.ondragZindex = 999, a.setElementProperty(b, "z-index", a.ondragZindex);
		for (var d = m(b),
			e = !1,
			f = 0; f < c.length; f++) {
			var g = c[f],
